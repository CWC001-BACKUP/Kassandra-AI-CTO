...
import {
  glassFieldClass,
  glassFieldDefaultClass,
  glassFieldErrorClass,
} from './surfaceStyles'
      ...
      <div className="space-y-1.5">
        ...
        <div className={isPassword ? 'relative' : undefined}>
          <input
            ...
            id={inputId}
            type={inputType}
            className={`${glassFieldClass} ${error ? glassFieldErrorClass : glassFieldDefaultClass} ${isPassword ? 'pr-11' : ''} ${className}`}
            {...props}
          />
          {isPassword && (
            <button
              ...
              className="btn-glass btn-glass-icon absolute right-2 top-1/2 -translate-y-1/2"
